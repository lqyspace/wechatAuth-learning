...
/**
 * @ClassName WxCpApiPathConsts
 * @Description 企业微信api地址常量类
 * @Author lengqy
 * @Date 2024年12月07日 20:56
 * @Version 1.0
 */
public interface WxCpApiPathConsts {
    ...
    interface Tp {
        ...
        /**
         * The constant GET_ADMIN_LIST. 旧版
         */
        String GET_ADMIN_LIST = "/cgi-bin/service/get_admin_list";
        /**
         * The constant GET_ADMIN_LIST. 新版
         */
        String GET_ADMIN_LIST_AGENT = "/cgi-bin/agent/get_admin_list";
        /**
        ...
        String GET_APP_PERMISSION = "/cgi-bin/agent/get_permissions";
